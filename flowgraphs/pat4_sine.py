...
class pat4_sine(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "pat4_sine")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 7200, 1, 1420, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_3, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 5200, 1100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=pat4_sine, options=None):
