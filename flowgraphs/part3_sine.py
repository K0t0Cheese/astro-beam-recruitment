...
class part3_sine(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "part3_sine")
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 5000, 0.1, 1420, 0)
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.blocks_throttle2_1, 0))
...
def main(top_block_cls=part3_sine, options=None):
